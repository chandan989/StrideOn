...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WepinCore/WepinCore.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WepinLogin/WepinLogin.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WepinModal/WepinModal.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/WepinWidget/WepinWidget.framework"
fi
